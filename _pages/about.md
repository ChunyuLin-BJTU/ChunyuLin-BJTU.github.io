...
### 学术成果
- 近年来围绕图像视频处理、三维视觉、基于视觉的辅助驾驶和基于视觉的VR/AR展开了相关研究，累计发表论文110余篇，包括在IEEE TIP、IEEE TCSVT、
  IEEE TMM、IEEE TITS、IEEE T-Broadcasting、IEEE JSTSP、IEEE SPL和ICCV、CVPR、ICME等重要刊物和会议上。部分重要论文见Publication页。
### 招生简介
- 理想的学生是品德好、编程强、数学优、英语棒。
- 有执行力、不浮躁、勤奋刻苦
- 招生方向与如上研究方向一致
